...
export function createApiClient(
  ...
  return {
    ...
    getCooperativeByHandle: (handle: string) =>
      request<CoopEntity>(
        `/cooperative/by-handle/${encodeURIComponent(handle)}`,
      ),
    ...
    getMember: (did: string) =>
      request<Member>(`/members/${encodeURIComponent(did)}`),
    ...
    removeMember: (did: string) =>
      request<void>(`/members/${encodeURIComponent(did)}`, {
        method: 'DELETE',
      }),
    ...
    getInvitations: (params?: { limit?: number; cursor?: string }) => {
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<InvitationsResponse>(
        `/invitations${qs.size ? `?${qs}` : ''}`,
      );
    },
    ...
    getInvitation: (token: string) =>
      request<PublicInvitationPreview>(`/invitations/${token}`),
    ...
    getAgreements: (params?: {
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<AgreementsResponse>(
        `/agreements${qs.size ? `?${qs}` : ''}`,
      );
    },
    ...
    openAgreement: (uri: string) =>
      request<Agreement>(`/agreements/${encodeURIComponent(uri)}/open`, {
        method: 'POST',
      }),

    activateAgreement: (uri: string) =>
      request<Agreement>(`/agreements/${encodeURIComponent(uri)}/activate`, {
        method: 'POST',
      }),

    terminateAgreement: (uri: string) =>
      request<Agreement>(`/agreements/${encodeURIComponent(uri)}/terminate`, {
        method: 'POST',
      }),
    ...
    retractSignature: (uri: string) =>
      request<void>(`/agreements/${encodeURIComponent(uri)}/sign`, {
        method: 'DELETE',
        body: JSON.stringify({}),
      }),

    voidAgreement: (uri: string) =>
      request<Agreement>(`/agreements/${encodeURIComponent(uri)}/void`, {
        method: 'POST',
      }),

    deleteAgreement: (uri: string) =>
      request<void>(`/agreements/${encodeURIComponent(uri)}`, {
        method: 'DELETE',
      }),
    ...
    addStakeholderTerms: (
      ...
      request<StakeholderTerms>(
        `/agreements/${encodeURIComponent(agreementUri)}/terms`,
        {
          method: 'POST',
          body: JSON.stringify(body),
        },
    ...
    listStakeholderTerms: (agreementUri: string) =>
      request<StakeholderTermsResponse>(
        `/agreements/${encodeURIComponent(agreementUri)}/terms`,
      ),

    removeStakeholderTerms: (agreementUri: string, termsUri: string) =>
      request<void>(
        `/agreements/${encodeURIComponent(agreementUri)}/terms/${encodeURIComponent(termsUri)}`,
        {
          method: 'DELETE',
        },
      ),
    ...
    getAgreementTemplates: (params?: { limit?: number; cursor?: string }) => {
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<AgreementTemplatesResponse>(
        `/agreement-templates${qs.size ? `?${qs}` : ''}`,
      );
    },
    ...
    getThreadPosts: (
      ...
      return request<PostsResponse>(
        `/threads/${id}/posts${qs.size ? `?${qs}` : ''}`,
      );
    },

    createPost: (
      threadId: string,
      body: { body: string; parentPostId?: string },
    ) =>
    ...
    getNetwork: (did: string) =>
      request<Network>(`/networks/${encodeURIComponent(did)}`),
    ...
    getNetworkMembers: (
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<NetworkMembersResponse>(
        `/networks/${encodeURIComponent(did)}/members${qs.size ? `?${qs}` : ''}`,
      );
    },

    joinNetwork: (did: string) =>
      request<{ ok: true }>(`/networks/${encodeURIComponent(did)}/join`, {
        method: 'POST',
      }),

    leaveNetwork: (did: string) =>
      request<void>(`/networks/${encodeURIComponent(did)}/leave`, {
        method: 'DELETE',
      }),
    ...
    getCampaigns: (params?: {
      ...
      if (params?.cooperativeDid)
        qs.set('cooperativeDid', params.cooperativeDid);
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
    ...
    deleteCampaign: (uri: string) =>
      request<void>(`/campaigns/${encodeURIComponent(uri)}`, {
        method: 'DELETE',
      }),
    ...
    getPledges: (
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<PledgesResponse>(
        `/campaigns/${encodeURIComponent(campaignUri)}/pledges${qs.size ? `?${qs}` : ''}`,
      );
    },

    // Payment providers
    getPaymentProviders: (campaignUri: string) =>
      request<PaymentProvidersResponse>(
        `/campaigns/${encodeURIComponent(campaignUri)}/providers`,
      ),
    ...
    createCheckout: (
      ...
      request<CheckoutResponse>(
        `/campaigns/${encodeURIComponent(campaignUri)}/checkout`,
        {
          method: 'POST',
          body: JSON.stringify({
            pledgeUri,
    ...
    getSupportedProviders: () =>
      request<{ providers: PaymentProviderInfo[] }>(
    ...
    updatePaymentConfig: (
      ...
      request<PaymentProviderConfig>(
        `/payment-providers/${encodeURIComponent(providerId)}`,
        {
          method: 'PUT',
          body: JSON.stringify(body),
        },
    ...
    deletePaymentConfig: (providerId: string) =>
      request<void>(`/payment-providers/${encodeURIComponent(providerId)}`, {
        method: 'DELETE',
      }),
    ...
    getInterests: () => request<InterestsListResponse>('/alignment/interests'),
    ...
    listOutcomes: (params?: {
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<OutcomesResponse>(
        `/alignment/outcomes${qs.size ? `?${qs}` : ''}`,
      );
    },
    ...
    supportOutcome: (
      uri: string,
      body: { level: string; conditions?: string },
    ) =>
      request<DesiredOutcome>(
        `/alignment/outcomes/${encodeURIComponent(uri)}/support`,
        {
          method: 'POST',
          body: JSON.stringify(body),
        },
    ...
    updateOutcomeStatus: (uri: string, status: string) =>
      request<DesiredOutcome>(
        `/alignment/outcomes/${encodeURIComponent(uri)}/status`,
        {
          method: 'POST',
          body: JSON.stringify({ status }),
        },
    ...
    getMap: () => request<InterestMap | null>('/alignment/map'),
    ...
    revokeConnection: (uri: string) =>
      request<void>(`/connections/${encodeURIComponent(uri)}`, {
        method: 'DELETE',
      }),
    ...
    bindResource: (
      ...
      request<ConnectionBinding>(
        `/connections/${encodeURIComponent(connectionUri)}/bind`,
        {
          method: 'POST',
          body: JSON.stringify(body),
        },
    ...
    listBindings: (connectionUri: string) =>
      request<BindingsResponse>(
        `/connections/${encodeURIComponent(connectionUri)}/bindings`,
      ),

    removeBinding: (uri: string) =>
      request<void>(`/connections/bindings/${encodeURIComponent(uri)}`, {
        method: 'DELETE',
      }),
    ...
    getExploreCooperatives: (params?: { limit?: number; cursor?: string }) => {
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<ExploreCooperativesResponse>(
        `/explore/cooperatives${qs.size ? `?${qs}` : ''}`,
      );
    },

    getExploreCooperative: (handle: string) =>
      request<ExploreCooperativeDetail>(
        `/explore/cooperatives/${encodeURIComponent(handle)}`,
      ),
    ...
    dismissMatch: (id: string) =>
      request<MatchActionResponse>(
        `/me/matches/${encodeURIComponent(id)}/dismiss`,
        {
          method: 'POST',
        },
      ),
    ...
    actOnMatch: (id: string) =>
      request<MatchActionResponse>(
        `/me/matches/${encodeURIComponent(id)}/act`,
        {
          method: 'POST',
        },
      ),
    ...
    getExplorePerson: (handle: string) =>
      request<ExplorePersonProfile>(
        `/explore/people/${encodeURIComponent(handle)}`,
      ),
    ...
    createAgentFromTemplate: (body: {
      agentType: string;
      name?: string;
      monthlyBudgetCents?: number;
    }) =>
      request<AgentConfig>('/agents/from-template', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    ...
    getAvailableModels: () =>
      request<AvailableModelsResponse>('/agents/models'),

    sendAgentMessage: (
      agentId: string,
      body: { message: string; sessionId?: string; model?: string },
    ) =>
      request<ChatResult>(`/agents/${agentId}/chat`, {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    ...
    getSessionMessages: (sessionId: string, cursor?: string) => {
      const qs = cursor ? `?cursor=${cursor}` : '';
      return request<AgentMessagesResponse>(
        `/agents/sessions/${sessionId}/messages${qs}`,
      );
    },
    ...
    getSupportedModelProviders: () =>
      request<{ providers: unknown[] }>('/model-providers/supported'),
    ...
    updateModelProvider: (providerId: string, body: Record<string, unknown>) =>
      request<ModelProviderConfig>(`/model-providers/${providerId}`, {
        method: 'PUT',
        body: JSON.stringify(body),
      }),
    ...
    getExploreNetworks: (params?: { limit?: number; cursor?: string }) => {
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<ExploreNetworksResponse>(
        `/explore/networks${qs.size ? `?${qs}` : ''}`,
      );
    },
    ...
    getTriggerExecutions: (
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<TriggerExecutionsResponse>(
        `/agents/triggers/${triggerId}/executions${qs.size ? `?${qs}` : ''}`,
      );
    },
    ...
    getLegalDocuments: (params?: {
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<LegalDocumentsResponse>(
        `/legal/documents${qs.size ? `?${qs}` : ''}`,
      );
    },
    ...
    getMeetings: (params?: {
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<MeetingRecordsResponse>(
        `/legal/meetings${qs.size ? `?${qs}` : ''}`,
      );
    },
    ...
    certifyMeeting: (id: string) =>
      request<MeetingRecord>(`/legal/meetings/${id}/certify`, {
        method: 'POST',
      }),
    ...
    getOfficers: (params?: {
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<OfficersResponse>(
        `/admin/officers${qs.size ? `?${qs}` : ''}`,
      );
    },
    appointOfficer: (body: {
      officerDid: string;
      ...
      request<Officer>('/admin/officers', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    updateOfficer: (
      id: string,
      body: { title?: string; termEndsAt?: string; responsibilities?: string },
    ) =>
      request<Officer>(`/admin/officers/${id}`, {
        method: 'PUT',
        body: JSON.stringify(body),
      }),
    ...
    getComplianceItems: (params?: {
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<ComplianceItemsResponse>(
        `/admin/compliance${qs.size ? `?${qs}` : ''}`,
      );
    },
    createComplianceItem: (body: {
      ...
      request<ComplianceItem>('/admin/compliance', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    updateComplianceItem: (
      ...
      request<ComplianceItem>(`/admin/compliance/${id}`, {
        method: 'PUT',
        body: JSON.stringify(body),
      }),
    completeComplianceItem: (id: string) =>
      request<ComplianceItem>(`/admin/compliance/${id}/complete`, {
        method: 'POST',
      }),
    ...
    getNotices: (params?: { limit?: number; cursor?: string }) => {
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<MemberNoticesResponse>(
        `/admin/notices${qs.size ? `?${qs}` : ''}`,
      );
    },
    createNotice: (body: {
      title: string;
      ...
      request<MemberNotice>('/admin/notices', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    ...
    getFiscalPeriods: (params?: { limit?: number; cursor?: string }) => {
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<FiscalPeriodsResponse>(
        `/admin/fiscal-periods${qs.size ? `?${qs}` : ''}`,
      );
    },
    createFiscalPeriod: (body: {
      label: string;
      startsAt: string;
      endsAt: string;
    }) =>
      request<FiscalPeriod>('/admin/fiscal-periods', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    updateFiscalPeriod: (
      ...
      request<FiscalPeriod>(`/admin/fiscal-periods/${id}`, {
        method: 'PUT',
        body: JSON.stringify(body),
      }),
    closeFiscalPeriod: (id: string) =>
      request<FiscalPeriod>(`/admin/fiscal-periods/${id}/close`, {
        method: 'POST',
      }),

    // ── Onboarding ───────────────────────────────────────────────────
    getOnboardingConfig: () =>
      request<OnboardingConfig | null>('/onboarding/config'),
    createOnboardingConfig: (body: {
      ...
      request<OnboardingConfig>('/onboarding/config', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    updateOnboardingConfig: (body: {
      probationDurationDays?: number;
      requireTraining?: boolean;
      requireBuyIn?: boolean;
      buyInAmount?: number;
    ...
    startOnboarding: (body: { memberDid: string }) =>
      request<OnboardingProgress>('/onboarding/start', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    getOnboardingProgress: (params?: {
      ...
      return request<OnboardingProgressResponse>(
        `/onboarding/progress${qs.size ? `?${qs}` : ''}`,
      );
    },
    getMemberOnboarding: (memberDid: string) =>
      request<OnboardingProgress | null>(
        `/onboarding/progress/${encodeURIComponent(memberDid)}`,
      ),
    completeTraining: (body: { memberDid: string }) =>
      request<OnboardingProgress>('/onboarding/training/complete', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    completeBuyIn: (body: { memberDid: string }) =>
      request<OnboardingProgress>('/onboarding/buy-in/complete', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    completeMilestone: (body: { memberDid: string; milestoneName: string }) =>
      request<OnboardingProgress>('/onboarding/milestone/complete', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    assignBuddy: (body: { memberDid: string; buddyDid: string }) =>
      request<OnboardingProgress>('/onboarding/buddy/assign', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    createOnboardingReview: (body: {
      memberDid: string;
      reviewType: string;
      outcome: string;
      comments?: string;
      ...
      request<OnboardingReview>('/onboarding/review', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    getOnboardingReviews: (memberDid: string) =>
      request<OnboardingReviewsResponse>(
        `/onboarding/reviews/${encodeURIComponent(memberDid)}`,
      ),
    completeOnboarding: (body: { memberDid: string }) =>
      request<OnboardingProgress>('/onboarding/complete', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    ...
    // ── Patronage ────────────────────────────────────────────────────
    getPatronageConfigs: () =>
      request<PatronageConfigsResponse>('/financial/patronage/config'),
    createPatronageConfig: (body: {
      stakeholderClass?: string;
      metricType: string;
      metricWeights?: Record<string, number>;
      cashPayoutPct?: number;
    }) =>
      request<PatronageConfig>('/financial/patronage/config', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    updatePatronageConfig: (
      id: string,
      body: {
        metricType?: string;
        metricWeights?: Record<string, number>;
    ...
    runPatronageCalculation: (body: {
      ...
      request<{ records: PatronageRecordsResponse['records'] }>(
        '/financial/patronage/calculate',
        { method: 'POST', body: JSON.stringify(body) },
      ),
    getPatronageRecords: (params: {
      fiscalPeriodId: string;
      limit?: number;
      cursor?: string;
    }) => {
      ...
      if (params.limit) qs.set('limit', String(params.limit));
      if (params.cursor) qs.set('cursor', params.cursor);
      return request<PatronageRecordsResponse>(
        `/financial/patronage/records?${qs}`,
      );
    },
    approvePatronageRecords: (body: { fiscalPeriodId: string }) =>
      request<{ approved: number }>('/financial/patronage/records/approve', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    getMemberPatronageRecords: (
      memberDid: string,
      params?: { limit?: number; cursor?: string },
    ) => {
      const qs = new URLSearchParams();
      ...
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<PatronageRecordsResponse>(
        `/financial/patronage/records/member/${encodeURIComponent(memberDid)}${qs.size ? `?${qs}` : ''}`,
      );
    },

    // ── Capital Accounts ─────────────────────────────────────────────
    recordContribution: (body: { memberDid: string; amount: number }) =>
      request<CapitalAccount>('/financial/capital-accounts/contribute', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    allocatePatronage: (body: { fiscalPeriodId: string }) =>
      request<{ allocated: number }>('/financial/capital-accounts/allocate', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    redeemAllocation: (body: { memberDid: string; amount: number }) =>
      request<CapitalAccount>('/financial/capital-accounts/redeem', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    getCapitalAccounts: (params?: { limit?: number; cursor?: string }) => {
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<CapitalAccountsResponse>(
        `/financial/capital-accounts${qs.size ? `?${qs}` : ''}`,
      );
    },
    getCapitalAccountSummary: () =>
      request<CapitalAccountSummary>('/financial/capital-accounts/summary'),
    getMemberCapitalAccount: (memberDid: string) =>
      request<CapitalAccount>(
        `/financial/capital-accounts/member/${encodeURIComponent(memberDid)}`,
      ),
    getMemberCapitalTransactions: (
      memberDid: string,
      params?: { limit?: number; cursor?: string },
    ) => {
      const qs = new URLSearchParams();
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<CapitalTransactionsResponse>(
        `/financial/capital-accounts/member/${encodeURIComponent(memberDid)}/transactions${qs.size ? `?${qs}` : ''}`,
      );
    },

    // ── Tax Forms 1099-PATR ──────────────────────────────────────────
    generateTaxForms: (body: { fiscalPeriodId: string; taxYear: number }) =>
      request<TaxFormsResponse>('/financial/tax-forms/1099-patr/generate', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    getTaxForms: (params?: {
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<TaxFormsResponse>(
        `/financial/tax-forms/1099-patr${qs.size ? `?${qs}` : ''}`,
      );
    },
    getTaxDeadlines: () =>
      request<{ forms: TaxForm1099[] }>(
        '/financial/tax-forms/1099-patr/deadlines',
      ),
    getTaxForm: (id: string) =>
      request<TaxForm1099>(`/financial/tax-forms/1099-patr/${id}`),
    markTaxFormGenerated: (id: string) =>
      request<TaxForm1099>(
        `/financial/tax-forms/1099-patr/${id}/mark-generated`,
        { method: 'POST' },
      ),
    markTaxFormSent: (id: string) =>
      request<TaxForm1099>(`/financial/tax-forms/1099-patr/${id}/mark-sent`, {
        method: 'POST',
      }),
    recordTaxFormPayment: (id: string) =>
      request<TaxForm1099>(
        `/financial/tax-forms/1099-patr/${id}/record-payment`,
        { method: 'POST' },
      ),
    ...
    createDelegation: (body: {
      ...
      request<Delegation>('/governance/delegations', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    revokeDelegation: (uri: string) =>
      request<Delegation>(
        `/governance/delegations/${encodeURIComponent(uri)}`,
        { method: 'DELETE' },
      ),
    getDelegations: (params?: {
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<DelegationsResponse>(
        `/governance/delegations${qs.size ? `?${qs}` : ''}`,
      );
    },
    getDelegationChain: (
      memberDid: string,
      params?: { scope?: string; proposalUri?: string },
    ) => {
      const qs = new URLSearchParams();
      if (params?.scope) qs.set('scope', params.scope);
      if (params?.proposalUri) qs.set('proposalUri', params.proposalUri);
      return request<DelegationChain>(
        `/governance/delegations/chain/${encodeURIComponent(memberDid)}${qs.size ? `?${qs}` : ''}`,
      );
    },
    getVoteWeight: (memberDid: string, proposalId: string) =>
      request<VoteWeightResponse>(
        `/governance/vote-weight/${encodeURIComponent(memberDid)}?proposalId=${proposalId}`,
      ),

    // ── Governance Feed ──────────────────────────────────────────────
    getGovernanceActionItems: (params?: {
      limit?: number;
      cursor?: string;
    }) => {
      const qs = new URLSearchParams();
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<GovernanceFeedResponse>(
        `/governance/feed/action-items${qs.size ? `?${qs}` : ''}`,
      );
    },
    getGovernanceOutcomes: (params?: { limit?: number; cursor?: string }) => {
      ...
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<GovernanceFeedResponse>(
        `/governance/feed/outcomes${qs.size ? `?${qs}` : ''}`,
      );
    },
    ...
    createMemberClass: (body: {
      ...
      request<MemberClass>('/member-classes', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    getMemberClass: (id: string) =>
      request<MemberClass>(`/member-classes/${id}`),
    updateMemberClass: (
      id: string,
      body: {
        name?: string;
    ...
    deleteMemberClass: (id: string) =>
      request<void>(`/member-classes/${id}`, { method: 'DELETE' }),
    assignMemberClass: (body: { memberDid: string; className: string }) =>
      request<{ memberDid: string; className: string }>(
        '/member-classes/assign',
        { method: 'POST', body: JSON.stringify(body) },
      ),
    removeMemberClass: (memberDid: string) =>
      request<{ memberDid: string; className: null }>(
        `/member-classes/assign/${encodeURIComponent(memberDid)}`,
        { method: 'DELETE' },
      ),

    // ── Cooperative Links ────────────────────────────────────────────
    getCooperativeLinks: (params?: {
      status?: string;
      linkType?: string;
      limit?: number;
      cursor?: string;
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<CooperativeLinksResponse>(
        `/cooperative-links${qs.size ? `?${qs}` : ''}`,
      );
    },
    createCooperativeLink: (body: {
      targetDid: string;
      linkType: string;
      description?: string;
    }) =>
      request<CooperativeLink>('/cooperative-links', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    getCooperativeLink: (id: string) =>
      request<CooperativeLink>(`/cooperative-links/${id}`),
    respondToLink: (id: string, body: { accept: boolean; message?: string }) =>
      request<CooperativeLink>(`/cooperative-links/${id}/respond`, {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    dissolveLink: (id: string) =>
      request<CooperativeLink>(`/cooperative-links/${id}`, {
        method: 'DELETE',
      }),
    getPartners: () =>
      request<{ partners: CooperativePartner[] }>(
        '/cooperative-links/partners',
      ),
    ...
    updateTask: (
      ...
      request<Task>(`/ops/tasks/${id}`, {
        method: 'PUT',
        body: JSON.stringify(body),
      }),
    deleteTask: (id: string) =>
      request<void>(`/ops/tasks/${id}`, { method: 'DELETE' }),
    getTasksByAssignee: (
      memberDid: string,
      params?: { limit?: number; cursor?: string },
    ) => {
      ...
      return request<TasksResponse>(
        `/ops/tasks/assignee/${encodeURIComponent(memberDid)}${qs.size ? `?${qs}` : ''}`,
      );
    },
    addChecklistItem: (
      taskId: string,
      ...
      request<ChecklistItem>(`/ops/tasks/${taskId}/checklist`, {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    updateChecklistItem: (
      id: string,
      body: { title?: string; completed?: boolean; sortOrder?: number },
    ) =>
      request<ChecklistItem>(`/ops/tasks/checklist/${id}`, {
        method: 'PUT',
        body: JSON.stringify(body),
      }),
    deleteChecklistItem: (id: string) =>
      request<void>(`/ops/tasks/checklist/${id}`, { method: 'DELETE' }),
    getTaskLabels: () => request<{ labels: TaskLabel[] }>('/ops/labels'),
    createTaskLabel: (body: { name: string; color?: string }) =>
      request<TaskLabel>('/ops/labels', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    deleteTaskLabel: (id: string) =>
      request<void>(`/ops/labels/${id}`, { method: 'DELETE' }),
    ...
    createTimeEntry: (body: {
      ...
      request<TimeEntry>('/ops/time-entries', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    getTimeEntries: (params?: {
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<TimeEntriesResponse>(
        `/ops/time-entries${qs.size ? `?${qs}` : ''}`,
      );
    },
    ...
    updateTimeEntry: (
      ...
      request<TimeEntry>(`/ops/time-entries/${id}`, {
        method: 'PUT',
        body: JSON.stringify(body),
      }),
    deleteTimeEntry: (id: string) =>
      request<void>(`/ops/time-entries/${id}`, { method: 'DELETE' }),
    submitTimeEntries: (body: { entryIds: string[] }) =>
      request<{ entries: TimeEntry[] }>('/ops/time-entries/submit', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    reviewTimeEntries: (body: {
      entryIds: string[];
      action: 'approve' | 'reject';
      note?: string;
    }) =>
      request<{ entries: TimeEntry[] }>('/ops/time-entries/review', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    getMemberTimeSummary: (
      memberDid: string,
      startDate: string,
      endDate: string,
    ) =>
      request<TimeSummary>(
        `/ops/time-entries/summary/member/${encodeURIComponent(memberDid)}?startDate=${startDate}&endDate=${endDate}`,
      ),
    getProjectTimeSummary: (
      ...
      request<ProjectTimeSummary>(
        `/ops/time-entries/summary/project/${encodeURIComponent(projectId)}?startDate=${startDate}&endDate=${endDate}`,
      ),
    ...
    createShift: (body: {
      ...
      request<ScheduleShift>('/ops/shifts', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    getShifts: (params?: {
    ...
    updateShift: (
      ...
      request<ScheduleShift>(`/ops/shifts/${id}`, {
        method: 'PUT',
        body: JSON.stringify(body),
      }),
    deleteShift: (id: string) =>
      request<void>(`/ops/shifts/${id}`, { method: 'DELETE' }),
    claimShift: (id: string) =>
      request<ScheduleShift>(`/ops/shifts/${id}/claim`, { method: 'POST' }),
    completeShift: (id: string) =>
      request<ScheduleShift>(`/ops/shifts/${id}/complete`, { method: 'POST' }),
    getShiftFairness: (startDate: string, endDate: string) =>
      request<FairnessSummary>(
        `/ops/shifts/fairness?startDate=${startDate}&endDate=${endDate}`,
      ),
    ...
    createExpenseCategory: (body: {
      ...
      request<ExpenseCategory>('/finance/expense-categories', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    getExpenseCategories: () =>
      request<{ categories: ExpenseCategory[] }>('/finance/expense-categories'),
    deleteExpenseCategory: (id: string) =>
      request<void>(`/finance/expense-categories/${id}`, { method: 'DELETE' }),
    createExpense: (body: {
      categoryId?: string;
      title: string;
      description?: string;
    ...
    getExpenses: (params?: {
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<ExpensesResponse>(
        `/finance/expenses${qs.size ? `?${qs}` : ''}`,
      );
    },
    ...
    reviewExpense: (
      ...
      request<Expense>(`/finance/expenses/${id}/review`, {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    reimburseExpenses: (body: { expenseIds: string[] }) =>
      request<{ reimbursed: number }>('/finance/expenses/reimburse', {
        method: 'POST',
        body: JSON.stringify(body),
      }),

    // ── Revenue (Phase 8) ────────────────────────────────────────────
    createRevenueEntry: (body: {
      projectId?: string;
      title: string;
      description?: string;
      amount: number;
      ...
      request<RevenueEntry>('/finance/revenue', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    getRevenueEntries: (params?: {
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<RevenueEntriesResponse>(
        `/finance/revenue${qs.size ? `?${qs}` : ''}`,
      );
    },
    getRevenueEntry: (id: string) =>
      request<RevenueEntry>(`/finance/revenue/${id}`),
    updateRevenueEntry: (
      id: string,
      body: {
    ...
    deleteRevenueEntry: (id: string) =>
      request<void>(`/finance/revenue/${id}`, { method: 'DELETE' }),
    getProjectRevenueSummary: (
      projectId: string,
      startDate: string,
      endDate: string,
    ) =>
      request<{ totalAmount: number; count: number; currency: string }>(
        `/finance/revenue/summary/project/${encodeURIComponent(projectId)}?startDate=${startDate}&endDate=${endDate}`,
      ),
    getOverallRevenueSummary: (startDate: string, endDate: string) =>
      ...
      }>(`/finance/revenue/summary?startDate=${startDate}&endDate=${endDate}`),

    // ── Commerce Listings (Phase 9) ──────────────────────────────────
    createCommerceListing: (body: {
      title: string;
      description?: string;
      category: string;
      availability?: string;
      ...
      request<CommerceListing>('/commerce/listings', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    getCommerceListings: (params?: {
      category?: string;
      status?: string;
      limit?: number;
      cursor?: string;
    ...
    getCommerceListing: (id: string) =>
      request<CommerceListing>(`/commerce/listings/${id}`),
    updateCommerceListing: (id: string, body: Record<string, unknown>) =>
      request<CommerceListing>(`/commerce/listings/${id}`, {
        method: 'PUT',
        body: JSON.stringify(body),
      }),
    deleteCommerceListing: (id: string) =>
      request<void>(`/commerce/listings/${id}`, { method: 'DELETE' }),

    // ── Commerce Needs (Phase 9) ─────────────────────────────────────
    createCommerceNeed: (body: {
      title: string;
      description?: string;
      category: string;
      urgency?: string;
      ...
      request<CommerceNeed>('/commerce/needs', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    getCommerceNeeds: (params?: {
      category?: string;
      status?: string;
      limit?: number;
      cursor?: string;
    ...
    updateCommerceNeed: (
      ...
      request<CommerceNeed>(`/commerce/needs/${id}`, {
        method: 'PUT',
        body: JSON.stringify(body),
      }),
    deleteCommerceNeed: (id: string) =>
      request<void>(`/commerce/needs/${id}`, { method: 'DELETE' }),

    // ── Inter-Coop Agreements (Phase 9) ──────────────────────────────
    createIntercoopAgreement: (body: {
      responderDid: string;
      title: string;
      description?: string;
      agreementType?: string;
      ...
      request<IntercoopAgreement>('/commerce/agreements', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    getIntercoopAgreements: (params?: {
      status?: string;
      limit?: number;
      cursor?: string;
    }) => {
    ...
    getIntercoopAgreement: (id: string) =>
      request<IntercoopAgreement>(`/commerce/agreements/${id}`),
    respondToIntercoopAgreement: (id: string, body: { accept: boolean }) =>
      request<IntercoopAgreement>(`/commerce/agreements/${id}/respond`, {
        method: 'POST',
        body: JSON.stringify(body),
      }),

    // ── Collaborative Projects (Phase 9) ─────────────────────────────
    createCollaborativeProject: (body: {
      title: string;
      description?: string;
      participantDids: string[];
      revenueSplit?: Record<string, number>;
    }) =>
      request<CollaborativeProject>('/commerce/projects', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    getCollaborativeProjects: (params?: {
      status?: string;
      limit?: number;
      cursor?: string;
    }) => {
    ...
    getCollaborativeProject: (id: string) =>
      request<CollaborativeProject>(`/commerce/projects/${id}`),

    // ── Shared Resources (Phase 9) ───────────────────────────────────
    createSharedResource: (body: {
      title: string;
      description?: string;
      resourceType: string;
      location?: string;
      ...
      request<SharedResource>('/commerce/resources', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    getSharedResources: (params?: {
      resourceType?: string;
      status?: string;
      limit?: number;
      cursor?: string;
    ...
    getSharedResource: (id: string) =>
      request<SharedResource>(`/commerce/resources/${id}`),
    createResourceBooking: (
      resourceId: string,
      body: { startsAt: string; endsAt: string; purpose?: string },
    ) =>
      request<ResourceBooking>(`/commerce/resources/${resourceId}/bookings`, {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    reviewResourceBooking: (
      id: string,
      body: { action: 'approve' | 'reject' },
    ) =>
      request<ResourceBooking>(`/commerce/bookings/${id}/review`, {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    ...
    // ── Connectors (Phase 9) ─────────────────────────────────────────
    getConnectorConfigs: () =>
      request<{ configs: ConnectorConfig[] }>('/connectors/configs'),
    createConnectorConfig: (body: {
      connectorType: string;
      displayName: string;
      config?: Record<string, unknown>;
      enabled?: boolean;
    }) =>
      request<ConnectorConfig>('/connectors/configs', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    deleteConnectorConfig: (id: string) =>
      request<void>(`/connectors/configs/${id}`, { method: 'DELETE' }),

    // ── Webhooks (Phase 9) ───────────────────────────────────────────
    getWebhookEndpoints: () =>
      request<{ endpoints: WebhookEndpoint[] }>('/webhooks/endpoints'),
    createWebhookEndpoint: (body: {
      ...
      request<WebhookEndpoint>('/webhooks/endpoints', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    deleteWebhookEndpoint: (id: string) =>
      request<void>(`/webhooks/endpoints/${id}`, { method: 'DELETE' }),
    getEventCatalog: () =>
      request<{ events: EventCatalogEntry[] }>('/webhooks/events'),
    ...
    getReportTemplates: () =>
      request<{ items: ReportTemplate[] }>('/reports/templates'),
    deleteReportTemplate: (id: string) =>
      request<void>(`/reports/templates/${id}`, { method: 'DELETE' }),
    generateReport: (body: {
      templateId?: string;
      reportType: string;
      title: string;
      ...
      request<ReportSnapshot>('/reports/generate', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    getReports: (params?: {
    ...
    getUnreadMentions: (params?: { limit?: number; cursor?: string }) => {
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<{ items: Mention[]; cursor: string | null }>(
        `/mentions${qs.size ? `?${qs}` : ''}`,
      );
    },
    markMentionAsRead: (id: string) =>
      request<void>(`/mentions/${id}/read`, { method: 'POST' }),
    markAllMentionsAsRead: () =>
      request<void>('/mentions/read-all', { method: 'POST' }),
    ...
    getDeadLetters: (params?: { limit?: number; cursor?: string }) => {
      ...
      if (params?.limit) qs.set('limit', String(params.limit));
      if (params?.cursor) qs.set('cursor', params.cursor);
      return request<DeadLettersResponse>(
        `/admin/hooks/dead-letter${qs.size ? `?${qs}` : ''}`,
      );
    },
    resolveDeadLetter: (id: string) =>
      request<{ ok: boolean }>(`/admin/hooks/dead-letter/${id}/resolve`, {
        method: 'POST',
      }),

    // ── Lexicons (V7 P7) ────────────────────────────────────────────
    getLexicons: () => request<LexiconsResponse>('/admin/lexicons'),
    registerLexicon: (body: {
      nsid: string;
      lexiconDoc: Record<string, unknown>;
      fieldMappings?: Record<string, unknown>;
    }) =>
      request<{ nsid: string; registered: boolean }>('/admin/lexicons', {
        method: 'POST',
        body: JSON.stringify(body),
      }),
    ...
    deleteLexicon: (nsid: string) =>
      request<{ nsid: string; removed: boolean }>(
        `/admin/lexicons/${encodeURIComponent(nsid)}`,
        { method: 'DELETE' },
      ),

    // ── Scripts (V7 P8) ─────────────────────────────────────────────
    getScripts: (coopDid: string) =>
      request<ScriptsResponse>(
        `/cooperatives/${encodeURIComponent(coopDid)}/scripts`,
      ),
    createScript: (
      coopDid: string,
      body: {
    ...
    getScript: (coopDid: string, id: string) =>
      request<CoopScript>(
        `/cooperatives/${encodeURIComponent(coopDid)}/scripts/${id}`,
      ),
    updateScript: (
      coopDid: string,
      id: string,
    ...
    enableScript: (coopDid: string, id: string) =>
      request<{ ok: boolean }>(
        `/cooperatives/${encodeURIComponent(coopDid)}/scripts/${id}/enable`,
        { method: 'POST' },
      ),
    disableScript: (coopDid: string, id: string) =>
      request<{ ok: boolean }>(
        `/cooperatives/${encodeURIComponent(coopDid)}/scripts/${id}/disable`,
        { method: 'POST' },
      ),
    testScript: (coopDid: string, id: string) =>
      request<ScriptTestResult>(
        `/cooperatives/${encodeURIComponent(coopDid)}/scripts/${id}/test`,
        { method: 'POST' },
      ),
    getScriptLogs: (coopDid: string, id: string) =>
      request<ScriptLogsResponse>(
        `/cooperatives/${encodeURIComponent(coopDid)}/scripts/${id}/logs`,
      ),
